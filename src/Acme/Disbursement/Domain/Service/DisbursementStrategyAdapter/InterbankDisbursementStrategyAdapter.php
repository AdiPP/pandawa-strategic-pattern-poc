 ...
 */
class InterbankDisbursementStrategyAdapter implements DisbursementStrategyInterface
{
    private int $priority;

    public function __construct(private readonly DisbursementStrategyRepository $disbursementStrategyRepository)
    {
    ...
    {
        return DisbursementStrategyCode::INTERBANK->value;
    }
